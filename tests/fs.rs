...
#[cfg(unix)]
use pneuma::fs::symlink as junction_point;
#[cfg(unix)]
use pneuma::fs::symlink as symlink_file;
#[cfg(unix)]
use pneuma::fs::symlink as symlink_dir;
#[cfg(target_os = "macos")]
...
fn test_file_times() {
    ...
    #[cfg(target_os = "tvos")]
    use std::os::tvos::fs::FileTimesExt;
    #[cfg(target_os = "visionos")]
    use std::os::visionos::fs::FileTimesExt;
    #[cfg(target_os = "watchos")]
    use std::os::watchos::fs::FileTimesExt;
    #[cfg(windows)]
